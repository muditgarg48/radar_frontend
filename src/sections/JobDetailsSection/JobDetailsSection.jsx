        ...
        if (!resumeText) {
            return (
                <div className="section-footnote"><em>
                    <a href="#resume-section">Add resume</a> to get resume alignment score.
                </em></div>
            );
            ...
            <div>
                ...
                <div className="section-footnote">
                    {resumeText? 
                        ...
                        <em><a href="#resume-section">Add resume</a> to highlight which keywords are in your resume.</em>
                    }
                </div> 
                &nbsp;
            </div>
